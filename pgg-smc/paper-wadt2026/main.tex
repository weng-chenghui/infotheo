...
This section constructs the paper's main eight-player instance. Each player
...
separate labels drawn from $C=\{0,1,\ldots,7\}$. The group $G=\PG$ acts on
...
We store the secret bit as the orbit class of the four positions occupied by
...
a physical rearrangement of the eight cards. A generator word specifies a
...
these three maps together with the inverses of translation and scaling. The
equality $|G|=336=8\cdot7\cdot6$ also matches the
...
fibers. For example, at $L=1$ the word consisting of the translation letter
