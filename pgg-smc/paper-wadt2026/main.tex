...
uniform group law. The formalization transports the resulting
...
The exact model makes the same assumption, since its single uniform shuffle
is likewise unobserved.
...
\begin{figure}[t]
  ...
  \end{tikzpicture}}
  \caption{The exact and finite-step proof paths. The lower path transports
