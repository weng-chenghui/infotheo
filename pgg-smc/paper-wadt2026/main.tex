...
bounds every observer's distinguishing advantage by $2^{-41}$.} This word-shuffle theorem transfers to single-card
...
\begin{table}[t]
  ...
  the distance in Equation~\ref{eq:l1-definition}.}
  \label{tab:instances}
\end{table}
