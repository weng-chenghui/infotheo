...
Card-protocol verification has used both proof assistants and automated
state-space search. Mizuki and Sone give formal models for card protocols and
small constructions~\cite{MizukiSone2009,MizukiSone2012}. Koch, Schrempp,
and Kirsten encode bounded protocol spaces for software bounded model
...
sharing and execution semantics. Single-shuffle constructions and their
complexity consequences provide further examples of algebraic shuffle
structure~\cite{ShinagawaNuida2021,ShinagawaNuida2025}.
