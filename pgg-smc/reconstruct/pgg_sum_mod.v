...
(******************************************************************************)
(* PGG-SMC: Single-Component Sum-mod-N Reconstruction                         *)
(*                                                                            *)
(* In the PGG protocol, a secret message m in Z/NZ is encoded as T starting   *)
(* sheets s_0, ..., s_{T-1} such that sum s_i = m (mod N).  After the walk,   *)
(* party i observes endpoint e_i = sigma_P(s_i).  To reconstruct, the parties *)
