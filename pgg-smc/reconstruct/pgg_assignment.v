...
(******************************************************************************)
(*                                                                            *)
(*            Assignment Graphs and Edge Coverage for PGG-SMC                 *)
(*                                                                            *)
(* This file defines assignment graphs and edge coverage for the              *)
(* (k,T)-threshold ramp scheme in PGG-SMC.                                   *)
(*                                                                            *)
(* An assignment graph captures which pairs of parties share a secret         *)
...
(*  cycle_graph T     == T-cycle: party i shares with party (i+1) mod T      *)
(*  complete_graph T  == complete graph: all party-pairs share a component    *)
(*                                                                            *)
(******************************************************************************)
