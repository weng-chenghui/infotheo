...
(*                                                                            *)
(* This file sits under homomorphic_encryption/ and depends on                *)
(* dumas2017dual/dsdp/: it consumes both layers rather than belonging to the  *)
(* scheme library, and it is the one edge in that direction.  Its line in     *)
(* _CoqProject therefore sits with the DSDP files, out of directory order.    *)
(*                                                                            *)
(* ```                                                                        *)
