...
(* being at most the total of the labels it spent.  So every label of s has   *)
(* its claim proved (hop_script_obligations), and a client reads a bound off  *)
(* a finished script without restating a triangle inequality.                 *)
(*                                                                            *)
