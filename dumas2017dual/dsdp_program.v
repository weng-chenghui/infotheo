...
Definition dsdp_tracesT := 3.-tuple (15.-bseq data).
...
Definition dsdp_uncurry (o: msg * msg * msg * msg * msg * msg * msg * msg) : dsdp_tracesT msg:=
...
Record dsdp_random_inputs :=
  DSDPRandomInputs {
    ...
    (* About independence of inputs:
      if a RV is generated by party#i then it is independent of party#j *)
}.
