...
- **dsdp_main.v** — the headline information-theoretic theorems, each proved over a cloned
  copy of its source section context; supporting machinery stays in the axis files.
