...
\begin{definition}[Walking the program into observations]
  ...
  termination. On receiving $\Enc_p(s)$ it emits $\mathsf{recv}(p,s,n)$ and
  recurses at $n{+}1$.
\end{definition}
...
\begin{theorem}[Information-theoretic leg]
  ...
  \[ \Pr[\, A \text{ guesses } v_2 \,] \ \le\ 1/m \quad
        \text{at the all-zero endpoint} \]
\end{theorem}
...
\begin{theorem}[Full secrecy by composition]
  ...
  \[ \text{total advantage} \ \le\ 1/m + 2\,\epscpa \]
\end{theorem}
