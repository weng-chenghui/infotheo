...
\begin{definition}[Single-hop IND-CPA bound]
  ...
  \rocqok
  A scheme $E$'s assumed IND-CPA real-or-zero advantage bound. For every scheme
  and every adversary, the advantage between the real-encryption oracle and the
  zero-encryption oracle is at most $\epscpaof{E}$. This is the one cryptographic
  assumption the chain rests on.
  \[ \forall E,\quad \AdvE(\Oreal, \Ozero, A) \le \epscpaof{E} \]
\end{definition}
