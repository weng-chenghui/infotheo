...
%   infotheo.dumas2017dual.dsdp.symbolic_game.dsdp_symbolic
...
\begin{definition}[Symbolic interpretation of the protocol]
  ...
  \rocq{infotheo.dumas2017dual.dsdp.symbolic_game.dsdp_symbolic.Symbolic_DSDP_Interface,
       infotheo.dumas2017dual.dsdp.symbolic_game.dsdp_symbolic.symbolic_data}
  \rocqok
...
\begin{definition}[Corrupted party's program]
  ...
  \rocq{infotheo.dumas2017dual.dsdp.symbolic_game.dsdp_symbolic.palice_sym}
  \rocqok
...
\begin{definition}[Sender programs and the challenge secret]
  ...
  \rocq{infotheo.dumas2017dual.dsdp.symbolic_game.dsdp_symbolic.pbob_sym,
       infotheo.dumas2017dual.dsdp.symbolic_game.dsdp_symbolic.pcharlie_sym,
       infotheo.dumas2017dual.dsdp.symbolic_game.dsdp_symbolic.dsdp_v2_name}
  \rocqok
  \uses{def:symbolic_interface}
...
\begin{lemma}[The assembled ciphertexts are derived]
  ...
  \rocq{infotheo.dumas2017dual.dsdp.symbolic_game.dsdp_symbolic.dsdp_observed_combines_eq}
  \rocqok
...
\begin{definition}[Received hop ciphertexts]
  ...
  \rocq{infotheo.dumas2017dual.dsdp.symbolic_game.dsdp_symbolic.dsdp_received_hop_ciphertexts,
       infotheo.dumas2017dual.dsdp.symbolic_game.dsdp_symbolic.first_send}
  \rocqok
...
\begin{definition}[Corrupted-view observations]
  \label{def:alice_obs}
  \rocq{infotheo.dumas2017dual.dsdp.symbolic_game.dsdp_game_symbolic.alice_obs}
  \rocqok
...
\begin{definition}[Synthesising the sample prefix]
  ...
  \rocq{infotheo.dumas2017dual.dsdp.symbolic_game.dsdp_game_symbolic.collect_samples}
  \rocqok
  \uses{def:alice_obs}
...
\begin{definition}[The whole corrupted-view trace]
  ...
  \rocq{infotheo.dumas2017dual.dsdp.symbolic_game.dsdp_game_symbolic.obs_of_procs}
  \rocqok
...
\begin{lemma}[The derived DSDP trace]
  ...
  \rocq{infotheo.dumas2017dual.dsdp.symbolic_game.dsdp_game_symbolic.obs_of_procs_dsdp}
  \rocqok
...
\begin{definition}[The DSDP corrupted-Alice trace]
  ...
  \rocq{infotheo.dumas2017dual.dsdp.symbolic_game.dsdp_game_symbolic.dsdp_alice_obs}
  \rocqok
...
\begin{definition}[Resolving names to positions]
  ...
  \rocq{infotheo.dumas2017dual.dsdp.symbolic_game.dsdp_game_symbolic.resolve_term}
  \rocqok
  \uses{def:embedding}
...
\begin{definition}[The lowering pass]
  ...
  \rocq{infotheo.dumas2017dual.dsdp.symbolic_game.dsdp_game_symbolic.game_of_trace}
  \rocqok
  \uses{def:lower_obs}
...
\begin{definition}[Hop counts]
  ...
  \rocq{infotheo.dumas2017dual.dsdp.symbolic_game.dsdp_game_symbolic.count_obs_hops,
...
\begin{lemma}[Hop-count adequacy]
  ...
  \rocq{infotheo.dumas2017dual.dsdp.symbolic_game.dsdp_game_symbolic.count_hops_game_of_trace}
  \rocqok
...
\begin{definition}[The secrecy-problem record]
  ...
  \rocq{infotheo.dumas2017dual.dsdp.symbolic_game.dsdp_game_symbolic.dsdp_indcpa_secrecy_problem}
  \rocqok
...
\begin{definition}[Corrupted view of a problem]
  ...
  \rocq{infotheo.dumas2017dual.dsdp.symbolic_game.dsdp_game_symbolic.corrupted_view}
  \rocqok
...
\begin{definition}[Real and all-zero games of a problem]
  \label{def:games}
  \rocq{infotheo.dumas2017dual.dsdp.symbolic_game.dsdp_game_symbolic.game_of_problem,
       infotheo.dumas2017dual.dsdp.symbolic_game.dsdp_game_symbolic.real_game,
       infotheo.dumas2017dual.dsdp.symbolic_game.dsdp_game_symbolic.zero_game}
  \rocqok
...
\begin{definition}[Valid adversary against a problem]
  \label{def:adversary}
  \rocq{infotheo.dumas2017dual.dsdp.symbolic_game.dsdp_game_symbolic.dsdp_indcpa_adversary}
  \rocqok
...
\begin{theorem}[Generic corrupted-view secrecy]
  ...
  \rocq{infotheo.dumas2017dual.dsdp.symbolic_game.dsdp_game_symbolic.dsdp_indcpa_secrecy}
  \rocqok
...
\begin{lemma}[The derived game matches the fixture]
  ...
  \rocq{infotheo.dumas2017dual.dsdp.symbolic_game.dsdp_game_symbolic.dsdp_faithful}
  \rocqok
...
\begin{definition}[The DSDP problem instance]
  ...
  \rocq{infotheo.dumas2017dual.dsdp.indcpa_hopping.dsdp_indcpa_security.dsdp_problem}
  \rocqok
...
\begin{lemma}[Two hops]
  ...
  \rocq{infotheo.dumas2017dual.dsdp.indcpa_hopping.dsdp_indcpa_security.dsdp_problem_hops}
  \rocqok
...
\begin{theorem}[DSDP corrupted-Alice secrecy]
  ...
  \rocq{infotheo.dumas2017dual.dsdp.indcpa_hopping.dsdp_indcpa_security.dsdp_problem_secure}
  \rocqok
...
\begin{corollary}[Loose-argument form]
  ...
  \rocq{infotheo.dumas2017dual.dsdp.indcpa_hopping.dsdp_indcpa_security.dsdp_advantage_derived}
  \rocqok
