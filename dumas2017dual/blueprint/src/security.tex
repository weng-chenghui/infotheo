...
\begin{definition}[What a setting proves]
  ...
  sequence, read at an asymptotic value supplied with that statement rather
  than carried by $\mathcal{X}$: the other twenty-five are made at one security
  parameter and do not read it.
