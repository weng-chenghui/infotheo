...
\begin{theorem}[The class-conditional trace bound]
  ...
  term $2\varepsilon_{\mathrm{cpa}}$ is conditional on $\mathcal{A}$, and prices
...
\begin{definition}[Decisional composite residuosity at modulus $pq$]
  ...
  \rocq{infotheo.dumas2017dual.dsdp.hopping.paillier_indcpa_scheme.dcr_assumption,
       infotheo.dumas2017dual.dsdp.hopping.paillier_indcpa_scheme.dcr_epsilon}
  \rocqok
  \uses{def:residuosity_assumption}
...
\begin{definition}[The IND-CPA assumption of Paillier, derived]
  ...
  $\varepsilon_{\mathrm{cpa}}$ off this value, so each is priced in
...
\begin{definition}[Higher residuosity at modulus $n$ and exponent $r$]
  ...
  \rocq{infotheo.dumas2017dual.dsdp.hopping.benaloh_indcpa_scheme.benaloh_residuosity_assumption,
       infotheo.dumas2017dual.dsdp.hopping.benaloh_indcpa_scheme.benaloh_residuosity_epsilon}
  \rocqok
  \uses{def:residuosity_assumption}
