...
\begin{definition}[One instance of a DSDP family]
  ...
  exactly the parameters every corrupted-Alice trace bound is stated at. The
  scheme enters as one component, so an instance and the assumption made about
  it name the same scheme.
