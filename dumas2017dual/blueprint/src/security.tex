...
\ref{ch:adversary_class} adds the one posited quantity, the advantage an
...
\begin{definition}[Real-or-zero advantage of a single-query adversary]
  ...
  \rocq{infotheo.dumas2017dual.dsdp.fdist_hopping.indcpa_game.enc_fdist,
       infotheo.dumas2017dual.dsdp.fdist_hopping.indcpa_game.indcpa_fdist_adversary,
       ...
       infotheo.dumas2017dual.dsdp.fdist_hopping.indcpa_game.indcpa_fdist_accept,
       infotheo.dumas2017dual.dsdp.fdist_hopping.indcpa_game.indcpa_fdist_success_real,
       infotheo.dumas2017dual.dsdp.fdist_hopping.indcpa_game.indcpa_fdist_success_realE,
       infotheo.dumas2017dual.dsdp.fdist_hopping.indcpa_game.indcpa_fdist_success_zero,
       infotheo.dumas2017dual.dsdp.fdist_hopping.indcpa_game.indcpa_fdist_success_zeroE,
       infotheo.dumas2017dual.dsdp.fdist_hopping.indcpa_game.indcpa_fdist_epsilon}
  \rocqok
...
\begin{theorem}[Guessing Bob's input from Alice's real tuple]
  ...
  \rocq{infotheo.dumas2017dual.dsdp.dsdp_main.dsdp_alice_guess_fdist_V2_real_le}
  \rocqok
  \uses{lem:alice_view_advantage,lem:guess_all_zero,def:distinguisher_of_guess}
...
\begin{theorem}[Unpredictability entropy]
  ...
  \rocq{infotheo.dumas2017dual.dsdp.fdist_hopping.dsdp_alice_fdist_secrecy.alice_predictor_unpredictability,
       infotheo.dumas2017dual.dsdp.dsdp_main.dsdp_alice_unpredictability_fdist_ge,
       infotheo.dumas2017dual.dsdp.dsdp_main.dsdp_alice_predictor_unpredictability_fdist_ge}
  \rocqok
...
\begin{corollary}[The same bound at Alice's full view]
  ...
  \rocq{infotheo.dumas2017dual.dsdp.fdist_hopping.dsdp_alice_fdist_secrecy.AliceCombineBob,
       ...
       infotheo.dumas2017dual.dsdp.dsdp_main.dsdp_alice_guess_fdist_view_le}
  \rocqok
...
\begin{theorem}[Bounded simulation security]
  ...
  \rocq{infotheo.dumas2017dual.dsdp.dsdp_main.dsdp_alice_sim_advantage_fdist_le}
  \rocqok
...
\begin{theorem}[The three bounds at the trace]
  ...
  \rocq{infotheo.dumas2017dual.dsdp.dsdp_main.dsdp_alice_guess_fdist_trace_V2_real_le,
       infotheo.dumas2017dual.dsdp.fdist_hopping.dsdp_alice_trace_link.alice_trace_predictor_unpredictability,
       infotheo.dumas2017dual.dsdp.dsdp_main.dsdp_alice_trace_predictor_unpredictability_fdist_ge,
       ...
       infotheo.dumas2017dual.dsdp.dsdp_main.dsdp_alice_trace_sim_advantage_fdist_le}
  \rocqok
...
\begin{theorem}[Trace, view, and tuple leave the same uncertainty]
  ...
  \rocq{infotheo.dumas2017dual.dsdp.fdist_hopping.dsdp_alice_trace_link.dsdp_alice_trace_tupleT,
       ...
       infotheo.dumas2017dual.dsdp.dsdp_main.centropy_AliceTrace_AliceRealTuple,
       infotheo.dumas2017dual.dsdp.dsdp_main.centropy_AliceView_AliceRealTuple}
  \rocqok
...
\begin{theorem}[The trace bound gated on a class]
  \label{thm:alice_guess_admissible}
  \rocq{infotheo.dumas2017dual.dsdp.fdist_hopping.dsdp_alice_trace_link.alice_trace_guess_pr,
       infotheo.dumas2017dual.dsdp.dsdp_main.dsdp_alice_guess_fdist_trace_V2_admissible_le,
       infotheo.dumas2017dual.dsdp.dsdp_main.dsdp_alice_guess_fdist_trace_V2_admissible_pq_le}
  \rocqok
  ...
  the two ciphertext replacements at the advantage $\mathcal{A}$ posits rather
...
\begin{corollary}[The bound at the Paillier scheme]
  ...
  \rocq{infotheo.dumas2017dual.dsdp.fdist_hopping.paillier_indcpa_instance.dsdp_alice_guess_fdist_trace_V2_admissible_paillier_le}
  \rocqok
...
\begin{lemma}[The gated bound is negligible as a family]
  \label{lem:negligible_guess_bound}
  \rocq{infotheo.dumas2017dual.dsdp.fdist_hopping.indcpa_game.negligible_fun_guess_bound}
  \rocqok
  \uses{def:negligible_fun,thm:alice_guess_admissible}
  The arithmetic shape of the gated bound is negligible whenever both of its
  summand families are.
  \[ \mathrm{negl}(k \mapsto \iota_k) \wedge \mathrm{negl}(k \mapsto \eta_k)
     \implies \mathrm{negl}\big(k \mapsto \iota_k + (\eta_k + \eta_k)\big) \]
  Both arguments are families of reals. A family of DSDP instances would carry
  a scheme, three key pairs and four weights per security parameter, making the
  bound a dependent family rather than an inequality between two real
  sequences.
\end{lemma}
...
\begin{theorem}[The class cannot admit every adversary]
  ...
  \rocq{infotheo.dumas2017dual.dsdp.dsdp_main.bob_trace_guess_epsilon_decrypt_ge,
       infotheo.dumas2017dual.dsdp.dsdp_main.bob_charlie_trace_guess_epsilon_decrypt_ge}
  \rocqok
  ...
  assumption admitting every adversary is therefore forced to posit
...
\begin{corollary}[A small-epsilon assumption must reject the decryptor]
  ...
  \rocq{infotheo.dumas2017dual.dsdp.dsdp_main.decrypt_reduction_not_admissible}
  \rocqok
  \uses{thm:decrypt_lower_bound}
  If $\mathcal{A}$ posits an advantage below $1 - 1/m$, its classifier answers
  false on the reduction adversary the decrypting predictor induces at Bob's
  key.
...
\begin{corollary}[The membership premises are not removable]
  \label{cor:admissible_premises_necessary}
  \rocq{infotheo.dumas2017dual.dsdp.dsdp_main.admissible_le_premises_necessary}
  \rocqok
  \uses{thm:alice_guess_admissible,thm:decrypt_lower_bound}
  Some assumption and predictor falsify the conclusion of
  Theorem~\ref{thm:alice_guess_admissible} read without its premises: take the
  classifier that admits nobody, with $\varepsilon_{\mathcal{A}} = 0$, and the
  decrypting predictor.
  \[ \exists\,\mathcal{A},\,g:\quad
     \Pr[\,g(\mathrm{AliceTrace}) = V_2\,] \not\le
       \tfrac{1}{m} + 2\,\varepsilon_{\mathcal{A}} \]
  That predictor succeeds with probability $1$ while the right-hand side is
  $1/m$, which is below $1$ because the plaintext space has at least two
  elements. The two premises are where the gated bound's truth lives.
\end{corollary}

\begin{theorem}[The trace determines Bob's input]
  \label{thm:centropy_trace_eq0}
  \rocq{infotheo.dumas2017dual.dsdp.dsdp_main.centropy_V2_AliceTrace_eq0}
  \rocqok
