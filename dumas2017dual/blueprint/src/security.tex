...
\begin{definition}[An assumption with a computed class and a proved promise]
  ...
  it gates are correspondingly weak; what it settles is that the record type
...
\begin{corollary}[The premise-free bound is false]
  ...
  \rocq{infotheo.dumas2017dual.dsdp.dsdp_main.dsdp_alice_guess_fdist_trace_V2_admissible_premise_free_lt}
  \rocqok
