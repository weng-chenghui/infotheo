(* MUTATION COPY 1 of probe_examples_f3.v — expected to FAIL.
   biased_uniform_eps is restated with RHS 4%:R^-1 instead of 6%:R^-1;
...
Lemma biased_uniform_eps : statdist biased3 unif3 = 4%:R^-1.
Proof.
