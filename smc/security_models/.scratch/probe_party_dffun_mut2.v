(* MUTANT 2 of probe_party_dffun.v: out_adv reads off the input
   component in_i instead of the output component out_i.
...
Definition out_adv (b : view_space) : y_adv := [ffun j => in_i (b j)].
