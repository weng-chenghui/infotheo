(* MUTATION of probe_unp_composition.v: the class edge is dropped from the
   conclusion of pred_success_le, leaving pred_success pi <= p_ideal.  coqc is
   expected to fail.
