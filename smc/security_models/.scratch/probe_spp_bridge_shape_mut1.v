(* MUTANT 1 of probe_spp_bridge_shape.v.  The hypothesis is required at
   a single fixed fibre kk0 instead of at every mass-carrying fibre.
...
Lemma cond_law_to_bind :
  (`Pr[ Kv = kk0 ] != 0 ->
     forall v : B, `Pr[ V = v | Kv = kk0 ] = k kk0 v) ->
  `p_ V = `p_ Kv >>= k.
Proof.
