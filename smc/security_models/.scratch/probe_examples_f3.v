...
(* MUTATION CHECKS — both copies live in this directory, both are
   rejected by coqc with exit status 1.
   1. probe_examples_f3_mut1.v : biased_uniform_eps restated with RHS
      4%:R^-1.  Line 136, at the closing lra:
        Error: Tactic failure: Cannot find witness.
   2. probe_examples_f3_mut2.v : mask_chan_uniform_hides restated with
      biased3 in place of unif3, and moved below biased3 so that the
      name is in scope.  Line 116, at the rewrite:
        Error: The LHS of fdist_uniformE (fdist_uniform _ _) does not
        match any subterm of the goal.
      The mutated statement is refuted by mask_chan_biased_leaks at
      x = 0, x' = 1.                                                 *)
