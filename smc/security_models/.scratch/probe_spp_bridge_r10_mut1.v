(* Mutation 1 of probe_spp_bridge_r10.v: the ideal share law adds Bob's
   share instead of subtracting it, so Alice's ideal share is a *d b + s.
   coqc must exit 1.                                                       *)
...
(* MUTATION: a *d b + s in place of a *d b - s. *)
